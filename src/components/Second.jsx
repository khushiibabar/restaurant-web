...
const Wws = () => {
  return (
    <div
      className="w-full min-h-screen bg-gradient-to-r from-red-50
     to-yellow-50 px-4 sm:px-6 lg:px-20 py-12 md:py-20 lg:py-24"
    >
      <div className="mx-auto text-center max-w-7xl">
        <h2
          className="text-2xl sm:text-3xl lg:text-4xl font-bold text-red-600
 uppercase font-poppins tracking-widest mb-3 animate-fade-in"
        >
          What we Serve
        </h2>
        <h1
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold
text-gray-900 font-poppins leading-tight mb-8 md:mb-12 lg:mb-16"
        >
 ...
 sm:gap-10 lg:gap-12"
        >
          ...
          {[
            ...
            sm:p-6 transition-transform duration-300"
            >
              <div className="overflow-hidden">
                <img
                  src={service.img}
                  alt={service.title}
                  className="w-full hover:rotate-7
 h-49 sm:h-56 md:h-48 lg:h-56 xl:h-64 object-contain lg:object-cover
  transition-transform duration-300"
                />
              </div>
              <h3
                className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600
 mt-4 sm:mt-6 font-poppins"
              >
                {service.title}
              </h3>
              <p
